...
import me.jellysquid.mods.sodium.client.world.biome.renderer.asm.Asm;
...
public class MixinPlugin implements IMixinConfigPlugin {
    private static final String mixinPackage = "me.jellysquid.mods.sodium.client.world.biome.renderer.mixin";
