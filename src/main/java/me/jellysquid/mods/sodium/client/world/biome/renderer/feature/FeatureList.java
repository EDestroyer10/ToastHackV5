...
import me.jellysquid.mods.sodium.client.world.biome.renderer.features.*;
...
public class FeatureList
{
	...
	public final MarlowCrystalFakeCPSFeature marlowCrystalFakeCPSFeature = new MarlowCrystalFakeCPSFeature();
	...
	public FeatureList()
	{
		...
		{
			String message = "Initializing Optimizer features";
