...
import me.jellysquid.mods.sodium.client.world.biome.renderer.events.PacketInputListener;
import me.jellysquid.mods.sodium.client.world.biome.renderer.events.PlayerTickMovementListener;
import me.jellysquid.mods.sodium.client.world.biome.renderer.events.SendMovementPacketsListener;
...
public class PacketFlyFeature extends Feature implements UpdateListener, SendMovementPacketsListener, PlayerTickMovementListener, PacketInputListener
{
	...
	public void onUpdate()
	{
		...
		if (MC.options.forwardKey.isPressed())
			dir = RotationUtils.getCwHackLookVec().multiply(1, 0, 1).normalize().multiply(0.031);
